...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-90a6692e.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-2c0b915a.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRequestFetch as a, useRouter as b, createError as c, entry$1 as default, navigateTo as n, useNuxtApp as u };
